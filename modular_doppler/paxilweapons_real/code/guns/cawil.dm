...
/obj/item/gun/ballistic/automatic/sol_rifle
	...
	fire_sound = 'modular_doppler/paxilweapons_real/sound/cawil/rifle_heavy.ogg'
	suppressed_sound = 'modular_doppler/paxilweapons_real/sound/cawil/suppressed_rifle.ogg'
	can_suppress = TRUE
